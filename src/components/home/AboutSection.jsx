...
export default function AboutSection() {
  ...
  const [isLowPerformance, setIsLowPerformance] = useState(true); // Default to true for SSR
  ...
  useEffect(() => {
    ...
    // Lazy initialize random image after mount
  ...
  return (
    ...
    >
      {/* Background geometric shapes - only for high-performance devices */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-center">
          ...
          >
            ...
            {/* Floating stats cards - simplified for lower performance devices */}
            {!isLowPerformance ? (
              <>
                {/* Original animated floating cards for high-performance devices */}
                <motion.div
              ...
              /* Static grid of stat cards for lower performance devices */
              <div className="grid grid-cols-2 gap-3 mt-4">
                <div className="bg-white rounded-xl shadow-sm p-3 flex items-center gap-3">
                  <div className="w-10 h-10 bg-theme/10 rounded-full flex items-center justify-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div>
                    ...
                    <p className="text-base font-bold text-theme font-display">
                      2,500+
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm p-3 flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-gray-500">Yearly Events</p>
                    <p className="text-base font-bold text-theme font-display">
                      150+
                    </p>
                  </div>
